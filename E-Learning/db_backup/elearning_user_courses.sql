...
CREATE TABLE `user_courses` (
  ...
  KEY `FKlqgnqmcg0mn2ci98xag6vxpdq` (`course_id`),
  KEY `FK4leaja1jtelxjs2iqqk4yuxna` (`user_id`),
  CONSTRAINT `FK4leaja1jtelxjs2iqqk4yuxna` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FKlqgnqmcg0mn2ci98xag6vxpdq` FOREIGN KEY (`course_id`) REFERENCES `course` (`id`)
...
INSERT INTO `user_courses` VALUES (1,1),(1,2),(1,4),(3,2),(3,1),(3,4),(3,5),(3,3),(4,1);
