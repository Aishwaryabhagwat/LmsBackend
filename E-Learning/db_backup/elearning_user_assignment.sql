...
CREATE TABLE `user_assignment` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK4ga5wfrp4a4stnjheci9psxh9` (`assignment_id`),
  KEY `FK2in5kss9ych887u3hbwvkjl58` (`user_id`),
  CONSTRAINT `FK2in5kss9ych887u3hbwvkjl58` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK4ga5wfrp4a4stnjheci9psxh9` FOREIGN KEY (`assignment_id`) REFERENCES `assignment` (`id`)
...
INSERT INTO `user_assignment` VALUES (1,_binary '',1,3),(2,_binary '',2,3),(3,_binary '',4,3),(4,_binary '',3,3),(5,_binary '',5,3),(6,_binary '',6,3),(7,_binary '',7,3),(8,_binary '',8,3),(9,_binary '',10,3);
